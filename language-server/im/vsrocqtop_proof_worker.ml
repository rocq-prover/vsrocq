...
let log = Im.ExecutionManager.ProofWorkerProcess.log
...
let _ =
  Coqinit.init_ocaml ();
  let opts, emoptions = Coqinit.parse_arguments ~parse_extra:Im.ExecutionManager.ProofWorkerProcess.parse_options ~usage:vsrocqtop_specific_usage () in
...
let () =
  Coqinit.init_ocaml ();
  let opts, emoptions = Coqinit.parse_arguments ~parse_extra:Im.ExecutionManager.ProofWorkerProcess.parse_options (List.tl (Array.to_list Sys.argv)) in
