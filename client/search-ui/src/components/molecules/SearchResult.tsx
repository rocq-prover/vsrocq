...
const searchResult: FunctionComponent<SearchResultProps> = (props) => {
    ...
    const classNames = hovered
        ? [classes.ResultHeader, classes.Hovered]
        : [classes.ResultHeader];
    const actionRowClasses = hovered
        ? [classes.ActionRow]
        : [classes.ActionRow, classes.Hidden];

    const chevron = collapsed ? (
        <VscChevronRight className={classes.CollapseButton} />
    ) : (
