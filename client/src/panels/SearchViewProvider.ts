            ...
            switch (command) {
                ...
                case "rocqQuery":
                    if (version && uri && position) {
                        ...
                        if (type === "search") {
                            const params: SearchRocqRequest = {
                                id,
                                textDocument,
                                pattern,
                                position,
                        ...
                        vscode.window.showErrorMessage(
                            "Search: " +
                                message.text +
                                " impossible. No active text editor.",
                        );
                    }
                    return;
